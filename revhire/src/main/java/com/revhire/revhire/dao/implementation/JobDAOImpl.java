...
public class JobDAOImpl implements JobDAO {
    ...
    public List<Job> searchByLocation(String location) {
        ...
        List<Job> jobs = new ArrayList<>();
        String sql = "SELECT * FROM jobs WHERE status='OPEN' AND LOWER(location) LIKE LOWER(?)";
    ...
    public List<Job> searchByJobType(String jobType) {
        ...
        List<Job> jobs = new ArrayList<>();
        String sql = "SELECT * FROM jobs WHERE status='OPEN' AND job_type = ?";
    ...
    public List<Job> searchByTitle(String title) {
        ...
        List<Job> jobs = new ArrayList<>();
        String sql = "SELECT * FROM jobs WHERE status = 'OPEN' AND LOWER(title) LIKE LOWER(?)";
